...
BASH_OUT_CONFIGS := $(addprefix $(BASH_ETC),$(etc_files))
$(BASH_OUT_CONFIGS): BASH_BINARY := $(LOCAL_MODULE)
$(BASH_OUT_CONFIGS): $(addprefix $(LOCAL_PATH)/etc/,$(etc_files)) $(LOCAL_INSTALLED_MODULE)
	@echo "Install: $@ -> $(BASH_ETC)"
	@mkdir -p $(BASH_ETC)
	$(hide) cp $(BASH_CONFIGS) $(BASH_ETC)

ALL_DEFAULT_INSTALLED_MODULES += $(BASH_OUT_CONFIGS)
