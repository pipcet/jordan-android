...
NANO_OUT_CONFIGS := $(addprefix $(NANO_ETC),$(etc_files))
$(NANO_OUT_CONFIGS): NANO_BINARY := $(LOCAL_MODULE)
$(NANO_OUT_CONFIGS): $(LOCAL_INSTALLED_MODULE)
	$(info $(NANO_CONFIGS))
	$(info $@)
	@echo "Install: $@ -> $(NANO_ETC)"
	@mkdir -p $(NANO_ETC)
	cp -f $(NANO_CONFIGS) $(NANO_ETC)

ALL_DEFAULT_INSTALLED_MODULES += $(NANO_OUT_CONFIGS)
